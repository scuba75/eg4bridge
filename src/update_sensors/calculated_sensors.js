...
async function calcBatteryRates(influxWrite, timeNow){
...
async function calcPvEnergy(influxWrite, timeNow){
...
async function calcLoadEnergy(influxWrite, timeNow){
...
export default async (influxWrite, timeNow) => {
  try {
    await calcBatteryRates(influxWrite, timeNow);
    await calcPvEnergy(influxWrite, timeNow);
    await calcLoadEnergy(influxWrite, timeNow);
  } catch (e) {
    log.error(e);
  }
};
